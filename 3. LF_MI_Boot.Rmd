...
Then run imputation: 
```{r}
system.time(imputedset <- mice(data=incompletedata, m=m, maxit=maxit, method=mymethod, predictorMatrix = pred, printFlag=T, seed=300, post=postproc, visitSequence = 'monotone'))
```
Check imputation: 
