...
# PSFMI, unpenalized logistic regression and Firth all require slightly different input dataframes, which we will prepare in this script. 
# We will prepare the dummy variables, and prepare the data format (e.g., long format for PSFMI analysis)
...
### Unpenalized logistic regression (GLM) ###
### Then repeat this to construct new imputed data in list format, which we need for the manual GLM analysis 
