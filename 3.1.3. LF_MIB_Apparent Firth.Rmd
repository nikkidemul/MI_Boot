...
```{r}
#correct (AUC from bootstrap internal validation) (original data) 
plogis(logit(0.67)-1.96*sqrt(0.01045727))
plogis(logit(0.67)+1.96*sqrt(0.01045727))
```
```{r}

#original (original data) 
plogis(logit(0.71)-1.96*sqrt(0.01045727))
plogis(logit(0.71)+1.96*sqrt(0.01045727))
```

For simualation data: 
```{r}
plogis(logit(0.63)-1.96*sqrt(0.01059245))
plogis(logit(0.63)+1.96*sqrt(0.01059245))
```
...
Myimp$lpF <- -1.60684935 + 0.02436147*(as.numeric(Myimp$age)) + 0.39068116*(as.numeric(Myimp$comorb_hypertension)) + 0.37620206*(as.numeric(Myimp$dummy_Hblow)) + 0.54483079*(as.numeric(Myimp$gender)) + -0.41904317*(as.numeric(Myimp$transhiatal))
